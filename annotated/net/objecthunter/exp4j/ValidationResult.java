...
public class ValidationResult {
    private final @Dimensionless boolean valid;
    private final @Dimensionless List<@Dimensionless String> errors;
     ...
     */
    public @Dimensionless boolean isValid(@Dimensionless ValidationResult this) {
        return valid;
    }
     ...
     */
    public @Dimensionless List<@Dimensionless String> getErrors(@Dimensionless ValidationResult this) {
        return errors;
    }
     ...
     */
    public static final ValidationResult SUCCESS = new @Dimensionless ValidationResult(true, null);
}
